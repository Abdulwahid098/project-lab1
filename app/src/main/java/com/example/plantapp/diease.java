...
public class diease extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diease);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Go to Home
                Intent intent = new Intent(diease.this, MainActivity.class);
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(diease.this, login.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        contactUs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(diease.this, contact.class);
                startActivity(intent);
                finish();
            }
        });
